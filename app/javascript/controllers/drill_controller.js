...
export default class extends Controller {
  static targets = [
    ...
    // Only present when FSRS_ENABLED=1; the controller guards with hasRetireOverlayTarget.
    "retireOverlay", "retireBubble", "retireWord"
  ]
  static values = { cards: Array, sentences: Array, from: String, to: String, recordUrl: String, fsrsEnabled: Boolean }
